...
class IndirectRefferalTable extends TableComponent
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->query(function () {
                if (!$this->userId) {
                    return User::query()->whereNull('id'); // empty
                }
                ...
                // Load indirect referrals with profile
                return $user->indirectReferrals()->with('profile');
            })
            ->columns([
    ...
    {
        return view('livewire.indirect-refferal-table');
    }
}
